...
export default function AdminLayout() {
  ...
  const allNavItems = [
    ...
    { path: '/admin/income-rules', icon: IndianRupee, label: 'Income Rules', permission: null, superAdminOnly: true },
    ...
    { path: '/admin/transfers', icon: IndianRupee, label: 'Transfers', permission: null, superAdminOnly: true },
    ...
    { path: '/admin/payout-reports', icon: IndianRupee, label: 'Payout Reports', permission: 'payoutReports', isPayoutReportsMenu: true },
  ...
  return (
    <div className="min-h-screen bg-dark">
      <div className="flex">
        {/* Sidebar */}
        <aside className="w-64 bg-dark-light border-r border-gray-800 p-4 sticky top-0 h-screen overflow-y-auto">
          <div className="mb-8">
